...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public EntryForExpirationDateAlarmViewModel(string itemId, string itemName, string unit, string lotId, double quantity, double minimumStockLevel, string locationId, string purchaseOrderNumber, string itemClassId, double timeLeft)
        {
            ItemId = itemId;
            ItemName = itemName;
            Unit = unit;

...
namespace TD.WareHouse.DemoApp.Core.Application.ViewModels.GoodsIssue
{
    public class GoodsIssueExternalToCreateViewModel : BaseViewModel
    {
        ...
        public GoodsIssueExternalToCreateViewModel(IApiService apiService, string goodsIssueId, string employeeId, string employeeName, string receiver, List<GoodsIssueEntry> entries)
        {
